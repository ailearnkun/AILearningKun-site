...
Kalau tulisan ini muncul di halaman blog, berarti seluruh rantainya bekerja: editor, commit ke GitHub, build otomatis, lalu terbit di situs.
...
2. **Penyimpanan** — frontmatter seperti judul, tanggal, tags, dan deskripsi tersimpan sesuai format situs
...
- **Tidak bisa login** — undangan belum diterima, atau gateway belum aktif
...
- **Muncul tapi tampilannya aneh** — format teks tidak sesuai yang dibaca situs

## Setelah ini

Kalau semua lolos, editor ini bisa dipakai untuk menulis sungguhan. Postingan uji coba ini boleh dihapus kapan saja.
